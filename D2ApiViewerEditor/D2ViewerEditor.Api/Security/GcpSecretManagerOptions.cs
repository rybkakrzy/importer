...
/// <summary>
/// GCP Secret Manager configuration (Qutas pattern). When enabled, the Entra client secret is
...
public sealed class GcpSecretManagerOptions
{
    ...
    /// <summary>Qutas naming: <c>SMC01{ENV}2_APP00404_entra_secret</c>.</summary>
