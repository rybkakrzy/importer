...
| R-25 | **Aktywacja Qutas niezweryfikowana runtime** (ADR-0012): walidacja tokenów Entra, mapowanie grup z realnego tokena, pobranie sekretu z GCP — nietestowane bez tenanta/GCP. Graph app-only wymaga `User.Read.All` + admin consent. | Medium | Medium | E2E na środowisku z realną konfiguracją. | Open |
