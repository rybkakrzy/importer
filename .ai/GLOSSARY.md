...
| Classification | C1/C2/C3/C4 — klasyfikacja dokumentu | opcjonalna przy ingeście (jeśli podana: C1..C4) |
...
| Zakończ i wyślij | Finalizacja dokumentu + wysyłka na ReturnUrl: synchroniczna 1. próba, kontynuacja/retry w tle | `FinishAndSendDocumentCommand` |
| DocumentStatus | Cykl życia dokumentu (Saved/Editing/Queued/Sending/SendAborted/DeliveryFailed/Sent) | kolumna `documents.status` |
| DocumentDelivery | Zadanie wysyłki w kolejce `document_deliveries` | aggregate-root |
| DeliveryStatus | Status zadania wysyłki | Pending/Sending/RetryScheduled/Sent/FailedPermanently/DeadLettered/Cancelled |
