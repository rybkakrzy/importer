...
public class BarcodeGeneratorService : IBarcodeGenerator
{
    ...
    public byte[] Generate(string content, string barcodeType, int width = 300, int height = 300, bool showText = false)
    {
        ...
        var showHumanReadableText = showText && IsOneDimensional(format);
